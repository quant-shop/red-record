---
title: "*Data Wells* in the Campaigns on State Violence"
...
# If some months are not abbreviated with a dot, try this alternative:
# df1893$Date <- as.Date(df1893$Date, format="%b %d, %Y")
# df1894$Date <- as.Date(df1894$Date, format="%b %d, %Y")
...
# Already in good shape, but you can factorize categorical variables if needed:
...
# --- Optional: Add a 'year' column to 1893 and 1894 for consistency ---
df1893$year <- 1893
df1894$year <- 1894

# --- Optional: Add missing columns to 1893/1894 with NA values for merging ---
...
# function to write data sets

write(x) = function(write.csv(x))
```
